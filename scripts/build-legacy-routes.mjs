...
const routes = {
  "pages/listochki": ["/archive/#worksheets", "Листочки перенесены в архив"],
  "pages/exams-1514": ["/archive/#exams", "Экзамены 1514 перенесены в архив"],
  ...
  "pages/leto-1514-modul-5": ["/archive/#old-pages", "Летние занятия 1514"],
